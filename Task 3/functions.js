...
// var element4 = document.getElementById("to_num").innerHTML= untilNum()
...
// Question 11
// var evenNum = Number(window.prompt("Enter a Number"))

// function evemNumbers(evenNum) {
    
//     var printEven = ""
//     for (let i = 2; i <= evenNum; i+=2) {
//         printEven += String(i) + " "
//     }
//     return printEven;
// }

// var element4 = document.getElementById("even_num").innerHTML= evemNumbers(evenNum)
